...
import {  addDoc,  arrayUnion,  doc,  getDoc, serverTimestamp,  setDoc,} from "firebase/firestore";
import { auth, firestore } from "../IIb/config";
  ...
  const signUp = async (email, password, username, fullname) => {
    try {
      ...
      await setDoc(doc(firestore, "user", `${user?.uid}`), {
        userId: user?.uid,
        biography: "Hey there! I'm my-first Instagram",
