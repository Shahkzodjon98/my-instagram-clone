...
import { addDoc,  arrayRemove,  collection,  doc,  limit, onSnapshot,  query,  serverTimestamp, updateDoc,  arrayUnion,} from "firebase/firestore";
...
const HomePostCard = ({ post }) => {
  ...
  return (
    <div
      ...
      className="sm:mb-5 bg-white sm:border-[1px] rounded"  >
      ...
      <div className=" sm:block sm:border-t-[1px] text-slate-900 p-3 border-slate-500/30">
        ...
        <form onSubmit={commentSubmit}>
          <div className="flex items-center gap-3" onClick={() => setEmoji((prev) => !prev)}>
          {/* <SmileSvg /> */}
            <SmileIcon size={34} />
